...
test.describe('HR Time-Off Request Wizard', () => {
  ...
  test.describe('Wizard Initialization', () => {
    test('opens wizard when Request Time Off button is clicked', async ({ page }) => {
    ...
    test('wizard starts at Select Type step', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('has 4 steps: Select Type, Select Dates, Conflict Check, Review', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('closes wizard on Escape key', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('closes wizard on Cancel button', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
  ...
  test.describe('Step 1: Select Type', () => {
    test('displays available time-off types with balances', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('shows balance progress bar for each type', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('disables types with zero balance', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('validates type selection before proceeding', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('proceeds to Select Dates step when type is selected', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
  ...
  test.describe('Step 2: Select Dates', () => {
    ...
    test('displays half-day checkboxes', async ({ page }) => {
    ...
    test('calculates and displays total days', async ({ page }) => {
      // Fill in dates
    ...
    test('adjusts total for half-day selections', async ({ page }) => {
      // Fill in dates
      await page.fill('#start-date', '2026-03-02');
      await page.fill('#end-date', '2026-03-06');
    ...
    test('shows warning when request exceeds balance', async ({ page }) => {
    ...
    test('validates dates are required', async ({ page }) => {
    ...
    test('allows adding optional notes', async ({ page }) => {
    ...
    test('proceeds to Conflict Check step with valid dates', async ({ page }) => {
      await page.fill('#start-date', '2026-03-02');
      await page.fill('#end-date', '2026-03-06');
    ...
    test('can navigate back to Select Type step', async ({ page }) => {
  ...
  test.describe('Step 3: Conflict Check', () => {
    ...
    test('displays conflict check heading', async ({ page }) => {
      const heading = page.locator('h4:has-text("Conflict Check")');
      await expect(heading).toBeVisible();
    });

    test('shows success message when no conflicts exist', async ({ page }) => {
    ...
    test('shows existing requests list if any exist', async ({ page }) => {
    ...
    test('proceeds to Review step', async ({ page }) => {
      await goToNextStep(page);
    ...
    test('can navigate back to Select Dates step', async ({ page }) => {
      await goToPreviousStep(page);
  ...
  test.describe('Step 4: Review & Submit', () => {
    ...
    test('displays request summary', async ({ page }) => {
      const summary = page.locator('.bg-secondary-50');
      await expect(summary).toBeVisible();
    });

    test('shows type in summary', async ({ page }) => {
      const typeRow = page.locator('text=Type:');
      await expect(typeRow).toBeVisible();
    });

    test('shows date range in summary', async ({ page }) => {
      const datesRow = page.locator('text=Dates:');
      await expect(datesRow).toBeVisible();
    });

    test('shows duration in summary', async ({ page }) => {
    ...
    test('shows notes in summary when provided', async ({ page }) => {
    ...
    test('shows manager info when available', async ({ page }) => {
    ...
    test('shows Submit Request button', async ({ page }) => {
      await expectSubmitButtonVisible(page);
    });

    test('submitting shows processing state', async ({ page }) => {
    ...
    test('can navigate back to Conflict Check step', async ({ page }) => {
      await goToPreviousStep(page);
  ...
  test.describe('Full Wizard Flow', () => {
    test('complete time-off request flow end-to-end', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
    ...
    test('preserves data when navigating backward', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
      await page.waitForSelector('[role="dialog"]', { timeout: 5000 });
  ...
  test.describe('Accessibility', () => {
    test('wizard has proper dialog role', async ({ page }) => {
      await page.goto(HR_TIME_OFF_URL);
      await page.click('[data-testid="request-time-off-button"]');
