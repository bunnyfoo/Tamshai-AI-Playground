...
| **QR Code Display** | BASE32-encoded | `***REDACTED_TOTP***` | What users see when scanning QR code |
| **oathtool / TOTP Apps** | BASE32-encoded | `***REDACTED_TOTP***` | Input for TOTP code generation |
